...
static rbnode_t * rbtree_node_min(rbnode_t *node, rbnode_t *sentinel)
{
    /* traverse left links */
...
rbnode_t* rbtree_min(rbtree_t *tree)
{
	...
	rbnode_t *sentinel = tree->sentinel;
...
static void rbtree_left_rotate(rbnode_t **root, rbnode_t *sentinel,rbnode_t *node)
{
	rbnode_t *temp;
...
static void rbtree_right_rotate(rbnode_t **root, rbnode_t *sentinel,rbnode_t *node)
{
	rbnode_t *temp;
...
void
rbtree_delete(rbtree_t *tree, rbnode_t *node)
{
	rbnode_t **root = &tree->root;
	rbnode_t *sentinel = tree->sentinel;
	rbnode_t *subst, *temp, *w;
    uint8_t red;
